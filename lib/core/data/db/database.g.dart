...
class $TransactionsTable extends Transactions
  ...
  List<GeneratedColumn> get $columns =>
      [id, title, value, isIncome, date, category];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  @override
  int get hashCode => Object.hash(id, title, value, isIncome, date, category);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class Budget extends DataClass implements Insertable<Budget> {
  final int id;
  final int value;
  const Budget({required this.id, required this.value});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<int>(id);
  ...
  Budget copyWith({int? id, int? value}) => Budget(
        id: id ?? this.id,
        value: value ?? this.value,
      );
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Budget && other.id == this.id && other.value == this.value);
}
...
class BudgetsCompanion extends UpdateCompanion<Budget> {
  ...
  BudgetsCompanion copyWith({Value<int>? id, Value<int>? value}) {
    return BudgetsCompanion(
      id: id ?? this.id,
      value: value ?? this.value,
    );
